    ...
    return (
      <div className='add-container'>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalFooter>
            <Button color="primary" onClick={() => {this.props.postArts(this.state); this.toggle()}}>Add</Button>
...
const mapDispatchToProps = dispatch => {
  return {
    postArts: (newArt) => {dispatch(postArts(newArt))
      }
  }
}

const AddCardArtContainer = 
    connect(null, mapDispatchToProps)(AddCardArt)

export default  AddCardArtContainer