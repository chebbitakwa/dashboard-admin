...
import {postThinkTanks} from '../../actions/actionThinkTank'
import {Label, Input, Button, Modal, ModalHeader, ModalBody, ModalFooter } from 'reactstrap';
import './AddCard.css'

export class AddCardThinkTank extends Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: false
    ...
    return (
      <div className='add-container'>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalFooter>
            <Button color="primary" onClick={() => {this.props.postThinkTanks(this.state); this.toggle()}}>Add</Button>
...
const mapDispatchToProps = dispatch => {
  return {
    postThinkTanks: (newThinkTank) => {dispatch(postThinkTanks(newThinkTank))
      }
  }
}

const AddCardThinkTankContainer = 
    connect(null, mapDispatchToProps)(AddCardThinkTank)

export default  AddCardThinkTankContainer