...
import {postWorkshops} from '../../actions/action'
    ...
    return (
      <div className='add-container'>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalFooter>
            <Button color="primary" onClick={() => {this.props.postWorkshops(this.state); this.toggle()}}>Add</Button>
...
const mapDispatchToProps = dispatch => {
  return {
    postWorkshops: (newWorkshop) => {dispatch(postWorkshops(newWorkshop))
      }
  }
}
