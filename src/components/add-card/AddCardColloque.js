...
import {postColloques} from '../../actions/actionColloque'
import {Label, Input, Button, Modal, ModalHeader, ModalBody, ModalFooter } from 'reactstrap';
import './AddCard.css'

export class AddCardColloque extends Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: false
    ...
    return (
      <div className='add-container'>
        ...
        <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          ...
          <ModalFooter>
            <Button color="primary" onClick={() => {this.props.postColloques(this.state); this.toggle()}}>Add</Button>
...
const mapDispatchToProps = dispatch => {
  return {
    postColloques: (newWorkshop) => {dispatch(postColloques(newWorkshop))
      }
  }
}

const AddCardColloqueContainer = 
    connect(null, mapDispatchToProps)(AddCardColloque)

export default  AddCardColloqueContainer